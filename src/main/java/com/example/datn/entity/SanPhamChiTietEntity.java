...
public class SanPhamChiTietEntity extends SuperEntity{
    ...
    @Column(name = "giaSanPham", length = 150, nullable = false, unique = false)
    private BigDecimal giaSanPham;
    @Column(name = "soLuong", length = 50, nullable = false, unique = false)
    private int soLuong;
    @Column(name = "trongLuong", length = 150, nullable = false, unique = false)
    private String trongLuong;
    @Column(name = "gioiTinh", length = 10, nullable = false, unique = false)
    private int gioiTinh;
    @Column(name = "moTa", length = 150, nullable = false, unique = false)
    private String moTa;
